...
export const metadata = {
  title: 'Technical SEO | Nexora Digital Marketing',
  description: 'Fix what\'s holding your site back. Speed optimization, Core Web Vitals, crawl issues, and more.',
}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Fix what\'s holding your site back - speed, Core Web Vitals, crawl issues, and more.
            </p>
            <div className="mt-8">
      ...
      <section className="py-24 bg-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">What We Fix</h2>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-white">
              Book a free consultation to discuss your technical SEO needs.
            </p>
            <div className="mt-8">
              <Link
