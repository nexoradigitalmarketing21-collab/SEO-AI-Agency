...
export const metadata = {
  title: 'Keyword Research | Nexora Digital Marketing',
  description: 'Discover high-value search opportunities. Our AI-powered keyword research finds untapped keywords your competitors are missing.',
}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Discover high-value search opportunities your competitors are missing.
            </p>
            <div className="mt-8">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-white">
              Book a free consultation to discuss your keyword research needs.
            </p>
            <div className="mt-8">
              <Link
