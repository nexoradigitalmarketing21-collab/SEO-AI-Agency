...
export const metadata = {
  title: 'Content Strategy | Nexora Digital Marketing',
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Create content that ranks, engages, and converts visitors into customers.
            </p>
            <div className="mt-8">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-white">
              Book a free consultation to discuss your content strategy needs.
            </p>
            <div className="mt-8">
              <Link
